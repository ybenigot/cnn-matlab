fprintf('hyperparameters CNN SGD 3 : 1 convolutional, 1 connected layers\n');
...
ei.activation_functions = ['tanh    ';'identity';'tanh    ';'softmax '];%softmax'];
...
ei.layer_sizes = [400*30, 100*30 , 50, ei.output_dim];
