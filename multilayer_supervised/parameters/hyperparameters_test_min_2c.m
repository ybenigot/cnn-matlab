...
ei.image_size = [ei.input_pixels,24];				% pixel size of image for each layer
ei.filter_sizes = [9,9];							% filter size for convolutional layers
ei.numFilters = [2,2];
ei.pool_dim = [-1,-1];
